...
void ResetTickCountRed ( ) {
	tickRed = 0;
}

void ResetTickCountGreen ( ) {
	tickGreen = 0;
}

void ResetTickCountBlue ( ) {
	tickBlue = 0;
}

uint32_t GetTickCountRed ( ) {
	return tickRed;
}

uint32_t GetTickCountGreen ( ) {
	return tickGreen;
}

uint32_t GetTickCountBlue ( ) {
	return tickBlue;
}
